...
import com.combostrap.html.util.FsUtil;
        ...
        for (Element linkElement : styleSheetElements) {
            ...
            if (!href.equals("")) {
                ...
                if (useBootstrapEmail && stylesheetPath.getFileName().toString().equals("bootstrap.min.css")) {
                    stylesheetString = FsUtil.readStringFromResource("/bootstrap-email/bootstrap-email.css");
                } else {
                    stylesheetString = FsUtil.readString(stylesheetPath);
                }
